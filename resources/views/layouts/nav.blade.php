...
<div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
    <div class="top-bar text-white-50 row gx-0 align-items-center d-none d-lg-flex">
        <div class="col-lg-6 px-5 text-start">
            <small><i class="fa fa-map-marker-alt me-4"></i>Houston, Tx 77099</small>
            {{-- <a href="//wa.me/+9477265341" target="_blank">077 265 341</a> --}}
            <small class="ms-4"><i class="fa-brands fa-whatsapp me-2"></i> <a href="//wa.me/+713-280-6838" target="_blank">713-280-6838</a></small>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="/blog" class="nav-item nav-link  {{ Request::segment(1) === 'team' ? 'active' : '' }}">Blog
                    and News</a>
                <a href="/contact"
